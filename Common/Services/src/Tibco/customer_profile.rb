Object.send(:remove_const, :CustomerProfileService) if Object.const_defined?(:CustomerProfileService)
...
#   <wsdl:operation name="SearchProfileByOpenID"></wsdl:operation>
#
# This will be translated to a ruby underscore style method call named "search_profile_by_open_id".  This can then be used as a client method call,
# as shown below in the Usage.  Currently, the SEARCH_PROFILE_BY_OPEN_ID_XML xml request string will need to be provided by the user.
#
# Refer to the parent base class (SoapService) for more information.
#
# == Usage
#      @client = CustomerProfileService.new("http://bwservicesqa.testgs.pvt/Marketing/CustomerProfile/CustomerProfileServiceV2")
#
class CustomerProfileService < SoapService
