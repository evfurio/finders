Object.send(:remove_const, :MembershipService) if Object.const_defined?(:MembershipService)
...
#
# == Usage
#      @client = MembershipService.new(multipass)
#
class MembershipService < SoapService
