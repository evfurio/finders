Object.send(:remove_const, :StoreInformationService) if Object.const_defined?(:StoreInformationService)
...
#
# == Usage
#      @client = StoreInformationService.new(multipass)
#
class StoreInformationService < SoapService
