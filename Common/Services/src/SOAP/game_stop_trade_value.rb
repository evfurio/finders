...
#   <wsdl:operation name="GetAddresses"></wsdl:operation>
#
# This will be translated to a ruby underscore style method call named "get_addresses".  This can then be used as a client method call,
# as shown below in the Usage.  Currently, the GET_ADDRESSES_XML xml request string will need to be provided by the user.
#
# Refer to the parent base class (SoapService) for more information.
#
# == Usage
#      @client = ProfileService.new("http://qa.services.gamestop.com/Ecom/Customers/Profile/v1/ProfileService.svc?wsdl")
#
class TradeValueService < SoapService
