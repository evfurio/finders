...
#   <wsdl:operation name="CalculateTax"></wsdl:operation>
#
# This will be translated to a ruby underscore style method call named "calculate_tax".  This can then be used as a client method call,
# as shown below in the Usage.  Currently, the CALCULATE_TAX_XML xml request string will need to be provided by the user.
#
# Refer to the parent base class (SoapService) for more information.
#
# == Usage
#      @client = TaxService.new("http://qa.services.gamestop.com/Ecom/Orders/Tax/v1/TaxService.svc?wsdl")
#
class TaxService < SoapService
