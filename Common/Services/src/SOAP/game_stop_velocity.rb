...
#
# == Usage
#      @client = ShippingService.new("http://dev.services.gamestop.com/Ecom/Orders/Fulfillment/Shipping/v1/ShippingService.svc?wsdl")
#
class VelocityService < SoapService
