...
#   <wsdl:operation name="AddProductsToCart"></wsdl:operation>
#
# This will be translated to a ruby underscore style method call named "add_products_to_cart".  This can then be used as a client method call,
# as shown below in the Usage.  Currently, the ADD_PRODUCTS_TO_CART_XML xml request string will need to be provided by the user.
#
# Refer to the parent base class (SoapService) for more information.
#
# == Usage
#      @client = CartService.new("http://qa.services.gamestop.com/Ecom/Orders/Cart/v1/CartService.svc?wsdl")
#
class CartService < SoapService
