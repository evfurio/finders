...
# instantiated directly, or be instantiated through one of the sub classes.
#
...
#
# == Usage
#      @client = DigitalContentService.new("http://dev.services.gamestop.com/Ecom/Fulfillment/v1/DigitalContentService.svc?wsdl")
#
class DigitalContentService < SoapService
