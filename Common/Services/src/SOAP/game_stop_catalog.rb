...
#   <wsdl:operation name="GetInventoryLevel"></wsdl:operation>
#
# This will be translated to a ruby underscore style method call named "get_inventory_level".  This can then be used as a client method call,
# as shown below in the Usage.  Currently, the GET_INVENTORY_LEVEL_XML xml request string will need to be provided by the user.
# 
# Refer to the parent base class (SoapService) for more information.
#
# == Usage
#      @client = CatalogService.new("http://qa.services.gamestop.com/Ecom/Merchandising/Catalog/v1/CatalogService.svc?wsdl")
#
class CatalogService < SoapService
