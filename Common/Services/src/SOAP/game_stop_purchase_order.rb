...
#
# == Usage
#      @client = PurchaseOrderService.new("http://dev.services.gamestop.com/Ecom/Orders/PurchaseOrder/v1/PurchaseOrderService.svc?wsdl")
#
class PurchaseOrderService < SoapService
