Object.send(:remove_const, :ChannelMultipassService) if Object.const_defined?(:ChannelMultipassService)
...
#
# == Usage
#      @client = ChannelMultipassService.new(multipass)
#
class ChannelMultipassService < SoapService
